...
<template>
  <div class="flex flex-col md:flex-row md:justify-between w-full max-w-full border border-gray-medium bg-white shadow-sm p-5 hover:bg-gray-100 transition-colors duration-200">
    <!-- 좌측 + 중앙 정보 -->
    <div class="flex flex-col justify-between min-h-[80px] w-full md:w-0 md:flex-grow md:pr-4">
      ...
      <!-- 캠페인명 -->
      <div
        class="mt-3 text-lg font-semibold truncate"
        :title="emailList.campaign_name"
      >
    ...
    <!-- 우측 버튼 -->
    <div class="flex flex-col justify-end items-end gap-5 w-full mt-5 md:mt-0 md:w-[160px] md:flex-shrink-0">
      <!-- 요청 버튼 -->
      <button
